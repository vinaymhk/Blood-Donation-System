...
CREATE TABLE `patient` (
  ...
  `blood_bankno` int(10) NOT NULL,
  `patient_name` varchar(50) DEFAULT NULL,
  `patient_bloodgroup` varchar(10) NOT NULL,
...
CREATE TABLE `bloodbank` (
  ...
  `patient id` int(10) NOT NULL,
  `donor id` int(10) NOT NULL,
  `blood_bankname` varchar(50) DEFAULT NULL,
  `blood_bankaddress` varchar(10) NOT NULL,
  `blood_bankdonor_name` varchar(20) DEFAULT NULL
)
